...
<template>
  <div>
    ...
    <div class="mt-4">
      ...
      <div
        v-for="item in page.boardCategory"
        :key="item.type"
    ...
    <div class="row mt-2">
      ...
      <div class="col-1">
        <label class="form-label">
          &nbsp <span class="text-body-secondary"></span
        ></label>
    ...
    <div class="my-5 d-flex">
      ...
      <div>
        <router-link
          :to="{ name: 'board/create', query: route.query }"
